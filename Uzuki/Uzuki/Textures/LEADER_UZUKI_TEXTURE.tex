...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="D:\Documents\Firaxis ModBuddy\346\LEADER_UZUKI_TEXTURE.png"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>3268426980</m_ExportedTime>
	<m_ClassName text="Leader_BaseColor"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="LEADER_UZUKI_TEXTURE.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="LEADER_UZUKI_TEXTURE"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
