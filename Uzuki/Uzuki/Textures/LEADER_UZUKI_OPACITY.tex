...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="D:\Documents\Firaxis ModBuddy\346\LEADER_UZUKI_OPACITY.png"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>888252544</m_ExportedTime>
	<m_ClassName text="Leader_OPAC"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="LEADER_UZUKI_OPACITY.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="LEADER_UZUKI_OPACITY"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
