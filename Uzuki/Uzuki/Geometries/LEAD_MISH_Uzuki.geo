...
<AssetObjects..GeometryInstance>
	...
	<m_DataFiles>
		<Element>
			<m_ID text="GR2"/>
			<m_RelativePath text="LEAD_MISH_Uzuki.fgx"/>
		</Element>
		<Element>
			<m_ID text="WIG"/>
			<m_RelativePath text="LEAD_MISH_Uzuki.wig"/>
		</Element>
	</m_DataFiles>
	<m_Name text="LEAD_MISH_Uzuki"/>
	<m_Description text="LEAD_MISH_Uzuki"/>
	<m_Tags>
		<Element text="Leader"/>
	</m_Tags>
</AssetObjects..GeometryInstance>
