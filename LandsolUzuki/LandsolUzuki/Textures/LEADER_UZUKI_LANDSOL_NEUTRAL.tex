...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="D:\Documents\Firaxis ModBuddy\LandsolUzuki\Texture2D\LEADER_UZUKI_LANDSOL_NEUTRAL.png"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>952508160</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="LEADER_UZUKI_LANDSOL_NEUTRAL.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="LEADER_UZUKI_LANDSOL_NEUTRAL"/>
	<m_Description text=""/>
	<m_Tags>
